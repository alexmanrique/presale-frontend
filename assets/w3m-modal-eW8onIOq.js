import{i as ve,s as fe,j as ge,p as be,M as g,S as re,R as l,k as v,l as P,m as f,n as a,A as K,o as ce,q as le,C as m,u as Y,v as ye,x as S,E as ie,O as E,y as q,z as oe,B as T,D as H,T as xe,F as Ce,G as ke,I as Se}from"./core-Dfkqo3ex.js";import{c as u,n as w,r as d,o as F,U as We}from"./index-LTu9JnBd.js";import"./index-7TS2r0U1.js";import"./index.es-CCPY7b4L.js";import"./events-DQ172AOg.js";import"./index-nibyPLVP.js";const p=be({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(s){return ge(p,()=>s(p))},subscribeKey(s,e){return fe(p,s,e)},showTooltip({message:s,triggerRect:e,variant:t}){p.open=!0,p.message=s,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await re.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
